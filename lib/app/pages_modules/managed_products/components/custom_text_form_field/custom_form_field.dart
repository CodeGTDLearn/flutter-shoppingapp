...
class CustomFormField {
  ...
  TextFormField create({
    ...
    return TextFormField(
      ...
      maxLines: fieldName == MAN_PROD_ADDEDIT_FLD_DESCR ? 3 : 1,
  ...
  void _loadTextFieldsParameters(String fieldName, Product product) {
    switch (fieldName) {
      case MAN_PROD_ADDEDIT_FLD_TITLE:
        {
        ...
        break;
      case MAN_PROD_ADDEDIT_FLD_PRICE:
        {
        ...
        break;
      case MAN_PROD_ADDEDIT_FLD_DESCR:
        {
        ...
        break;
      case MAN_PROD_ADDEDIT_FLD_IMG_URL:
        {
  ...
  void _loadProductWithFieldValue(String field, Product prod, var value) {
    if (field == MAN_PROD_ADDEDIT_FLD_TITLE) prod.title = value;
    if (field == MAN_PROD_ADDEDIT_FLD_PRICE) prod.price = double.parse(value);
    if (field == MAN_PROD_ADDEDIT_FLD_IMG_URL) prod.imageUrl = value;
    if (field == MAN_PROD_ADDEDIT_FLD_DESCR) prod.description = value;
  }
}
