...
mixin _$OrderCollapsableTileStore on OrderCollapsableTileStoreI, Store {
  final _$collapsingTileIconAtom =
      Atom(name: 'OrderCollapsableTileStoreI.collapsingTileIcon');
  ...
  final _$isTileCollapsedAtom =
      Atom(name: 'OrderCollapsableTileStoreI.isTileCollapsed');
  ...
  final _$OrderCollapsableTileStoreIActionController =
      ActionController(name: 'OrderCollapsableTileStoreI');

  @override
  void toggleCollapseTile() {
    final _$actionInfo =
        _$OrderCollapsableTileStoreIActionController.startAction();
    try {
      return super.toggleCollapseTile();
    } finally {
      _$OrderCollapsableTileStoreIActionController.endAction(_$actionInfo);
    }
  }
