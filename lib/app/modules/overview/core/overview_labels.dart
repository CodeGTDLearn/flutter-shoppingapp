class OverviewLabels {
  final _OVERVIEW_TITLE_PAGE = "Selling Items";
  ...
  get title_appbar => _OVERVIEW_TITLE_PAGE;

  get title_fav => _OVERVIEW_TITLE_PAGE_FAVORITE;

  get popup_fav => _OVERVIEW_FAVORITES_POPUP_FILTER_OPTION;
